...
elseif (blk_name.entries(bl) =='div2') then
    chdir $FPAAHOME/Downloads/vtr_release/vtr_flow
    unix_g(' perl $FPAAHOME/Downloads/vtr_release/vtr_flow/scripts/run_vtr_flow.pl $FPAAHOME/Downloads/vtr_release/vtr_flow/benchmarks/verilog/divBy2.v $FPAAHOME/Downloads/vtr_release/vtr_flow/arch/timing/k6_N10_memDepth16384_memData64_40nm_timing.xml -ending_stage scripts')
    unix_g('cp $FPAAHOME/Downloads/vtr_release/vtr_flow/temp/div*  $FPAAHOME/Downloads/vtr_release/vtr_flow/') 
    //unix_g('cd $FPAAHOME/Downloads/vtr_release/vtr_flow ')
    ...
    unix_g('cp $FPAAHOME/Downloads/vtr_release/vtr_flow/div2.blif .')
