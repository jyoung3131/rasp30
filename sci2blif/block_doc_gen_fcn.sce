...
function block_doc_name_callback()
    ...
    file_list=listfiles("$FPAAHOME/rasp30/sci2blif/documentation/blocks_latex/text/*.tex");
    block_doc_list=[""];
...
function Gen_block_doc_callback()
    ...
    fd_w= mopen("$FPAAHOME/rasp30/sci2blif/documentation/blocks_latex/text/"+block_doc_name+".tex",'wt');
    ...
    unix_w("cat $FPAAHOME/rasp30/sci2blif/documentation/blocks_latex/text/"+block_doc_name+".tex "+block_doc_bdt+" > $FPAAHOME/rasp30/sci2blif/documentation/blocks_latex/text/"+block_doc_name+".tex1");
    unix_w("mv $FPAAHOME/rasp30/sci2blif/documentation/blocks_latex/text/"+block_doc_name+".tex1 $FPAAHOME/rasp30/sci2blif/documentation/blocks_latex/text/"+block_doc_name+".tex");
    temp_string=strsplit(block_doc_bdf,["/";"."],100);
    size_temp_string=size(temp_string,1);
    unix_w("cp "+block_doc_bdf+" $FPAAHOME/rasp30/sci2blif/documentation/blocks_latex/figures/"+block_doc_name+"."+temp_string(size_temp_string));
    
    fd_w= mopen("$FPAAHOME/rasp30/sci2blif/documentation/blocks_latex/text/"+block_doc_name+".tex",'a');
    mputl("",fd_w);
    mputl("\begin{figure}[H]  % jpg, png, or pdf",fd_w);
    mputl("\includegraphics[width=300pt]{$FPAAHOME/rasp30/sci2blif/documentation/blocks_latex/figures/"+block_doc_name+"."+temp_string(size_temp_string)+"}",fd_w);
    ...
    fd_w= mopen("$FPAAHOME/rasp30/sci2blif/documentation/blocks_latex/block_list.tex",'wt');
    for ii=1:size_flist
        mputl("\input{$FPAAHOME/rasp30/sci2blif/documentation/blocks_latex/text/"+block_doc_list(ii)+".tex}",fd_w);
    end
    mclose(fd_w);
    
    [a,b]=unix_g("cd $FPAAHOME/rasp30/sci2blif/documentation/blocks_latex/ && pdflatex $FPAAHOME/rasp30/sci2blif/documentation/blocks_latex/block_doc.tex");
    if b == 1 then
    ...
    [a,b]=unix_g("acroread $FPAAHOME/rasp30/sci2blif/documentation/blocks_latex/block_doc.pdf &"); 
