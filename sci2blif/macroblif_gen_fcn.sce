...
function Start_MB_design_callback()
    ...
    for ii=1:l_file_list
        if file_list(ii) == "$FPAAHOME/rasp30/xcos_blocks/"+Macroblif_name+".sci" then messagebox('Please change the name of macro-cab block.', "Macroblock name error", "error"); abort; end
    end
...
function Generate_MB_callback()
    ...
    file_name = "$FPAAHOME/RASP_Workspace/"+folder_name+"/"+Macroblif_name+".xcos";
    ...
    while ele_index(1) ~= ".end",
        ...
        fd_r1 = mopen("$FPAAHOME/rasp30/sci2blif/block_info/bi_"+ele_index(2)+'.sci','r');
    ...
    //////////////////////////////////
    fd_w= mopen("$FPAAHOME/rasp30/sci2blif/block_info/bi_"+Macroblif_name+".sci",'wt');
    ...
    mblif_xcos_r=[""];
    ele_index_r=[""];
    fd_r = mopen("$FPAAHOME/rasp30/sci2blif/block_info/bi_"+Macroblif_name+".sci",'r');
    for i=1:7
    ...
    fd_w= mopen ("$FPAAHOME/rasp30/xcos_blocks/"+Macroblif_name+".sci",'wt');
    ...
    //////////////////////////////////////////////
    fd_w= mopen ("$FPAAHOME/rasp30/sci2blif/rasp_design_added_blocks/"+Macroblif_name+".sce",'wt');
    ...
    fd_w= mopen ("$FPAAHOME/rasp30/sci2blif/sci2blif_added_blocks/"+Macroblif_name+".sce",'wt');
    ...
    if vcc_flag == 1 | gnd_flag == 1 then
        fd_w= mopen ("$FPAAHOME/rasp30/sci2blif/sci2pads_added_blocks/"+Macroblif_name+".sce",'wt');
    ...
    unix_w("cp "+Macroblif_name+".xcos $FPAAHOME/rasp30/sci2blif/xcos_ref/macroblif_generation/");
