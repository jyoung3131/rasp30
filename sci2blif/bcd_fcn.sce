...
function bcd_xcosgen_callback()
    ...
    //unix_g("cp $FPAAHOME/rasp30/sci2blif/bcd_added_blocks/bcd_frame01.sci bcd_frame01.sci");
    //unix_g("cp $FPAAHOME/rasp30/sci2blif/bcd_added_blocks/bcd_frame02.sci bcd_frame02.sci");
    ...
    while inputs_temp(1) == "b" | inputs_temp(1) == "c"
        ...
        if inputs_temp(1) == "b" then
            fd_r1 = mopen("$FPAAHOME/rasp30/sci2blif/bcd_added_blocks/bcd_"+inputs_temp(2)+".sci",'r');  // inputs_temp(2) : block name
